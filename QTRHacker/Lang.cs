...
namespace QTRHacker
{
	...
	public class Lang
	{
		...
		public static string exploreAll = "Explore the whole world", rightClickToTP = "Right click to TP(MapFullScreen)", showInvisiblePlayers = "Show invisible players";
		public static string icon = "Icon", details = "Details", name = "Name", type = "Type", rare = "Rare", ID = "ID", name_en = "English Name", name_cn = "Chinese Name";
		...
		public static string exploreAll = "探索全地图", rightClickToTP = "右键大地图传送", showInvisiblePlayers = "显示隐身的玩家";
		public static string icon = "图标", details = "详细信息", name = "名称", type = "类型", rare = "品质", ID = "ID", name_en = "英文名称", name_cn = "中文名称";
