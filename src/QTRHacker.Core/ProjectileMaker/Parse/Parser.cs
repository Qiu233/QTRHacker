...
public class Parser
{
	...
	{
		Expr_BTuple T = new(Current.Index);
	...
	{
		Stmt_MACRO stmt = new(Current.Index);
		Accept(TokenType.LEFT_BRACKET);
	...
	{
		Stmt_POINT stmt = new(Current.Index);
		Accept(TokenType.LEFT_BRACKET);
	...
	{
		Stmt_RECT stmt = new(Current.Index);
		Accept(TokenType.LEFT_BRACKET);
		stmt.Type = GetExprArg();
		stmt.Unit = GetBTuple();
		stmt.Location = GetBTuple();
	...
	{
		Stmt_RECT_FILLED stmt = new(Current.Index);
		Accept(TokenType.LEFT_BRACKET);
		stmt.Type = GetExprArg();
		stmt.Unit = GetBTuple();
		stmt.Location = GetBTuple();
	...
	{
		Stmt_FIXED stmt = new(Current.Index);
		Accept(TokenType.LEFT_BRACKET);
	...
	private Stmt_DEF GetDef()
	{
		...
		Stmt_DEF stmt = new(Current.Index);
		Accept(TokenType.LEFT_BRACKET);
		stmt.Name = Current.Value;
		Accept(TokenType.NAME);
		Accept(TokenType.RIGHT_BRACKET);
	...
	{
		Stmt_INSERT stmt = new(Current.Index);
		Accept(TokenType.LEFT_BRACKET);
		stmt.Name = Current.Value;
		Accept(TokenType.NAME);
		Accept(TokenType.COMMA);
