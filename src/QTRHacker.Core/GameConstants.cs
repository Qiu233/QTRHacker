// Generated by GameWikiResExporter from the selected Terraria assembly.
namespace QTRHacker.Core;

public static class GameConstants
{
	public const string GameVersion = "1.4.5.8";
	public const int MaxItemTypes = 6196;
	public const int MaxNPCTypes = 697;
	public const int MaxPlayerBuffs = 44;
