...
}		public virtual GameObjectArrayV<byte> StreamPlayer
{
	get => new GameObjectArrayV<byte>(Context, InternalObject.streamPlayer);
	set => InternalObject.streamPlayer = value.InternalObject;
...
}		public virtual GameObjectArrayV<int> KillCount
{
	get => new GameObjectArrayV<int>(Context, InternalObject.killCount);
	set => InternalObject.killCount = value.InternalObject;
...
}		public virtual string GivenName
{
	...
	set => InternalObject._givenName = GameObjects.GameString.New(Context, value).TypedInternalObject;
}
#endregion
	}
}